# TraceCap Backend API Endpoints
...
**Storage Layer:**
- **MinIO**: Object storage for PCAP files (`tracecap-files` bucket)
...
3. Backend uploads to MinIO: `s3://tracecap-files/{fileId}.pcap`
...
Response: 201 Created
{
  ...
  "status": "processing",
  "storageLocation": "s3://tracecap-files/uuid-v4.pcap"
}
...
5. Uploads to MinIO: tracecap-files/{fileId}.pcap
...
Backend Processing:
1. Deletes file from MinIO: tracecap-files/{fileId}.pcap
...
{
  "fileId": "uuid-v4",
  "uploadUrl": "http://localhost:9000/tracecap-files/uuid-v4.pcap?X-Amz-...",
...
### MinIO Storage
9. Files are stored in MinIO bucket: `tracecap-files`
