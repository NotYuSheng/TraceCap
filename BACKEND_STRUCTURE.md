# TraceCap Backend - Project Structure
...
└── backend/
    ...
    │   │   │   └── com/
    │   │   │       └── tracecap/
    │   │   │           ├── TracecapApplication.java          # Main application class
    │   │   │           │
...
spring:
  ...
  profiles:
    active: dev
  datasource:
    url: jdbc:postgresql://localhost:5432/tracecap
    username: tracecap_user
    password: tracecap_pass
  jpa:
    hibernate:
      ddl-auto: validate
    show-sql: false
